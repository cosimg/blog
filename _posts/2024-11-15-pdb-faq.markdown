...
NO. Infantry cannot perform a reactive retreat.
...
Cavalry, horse artillery (if limbered up), mobile infantry and mobile communication elements (bicycle or mounted) can perform a reactive retreat.
...
**2. Why is everyone so mean to me?**
